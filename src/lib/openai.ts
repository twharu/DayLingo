...
**🚨 重要：讀音標注規則**
- **每一個漢字都必須標注讀音**，不能遺漏任何一個漢字
- 使用格式：<ruby>漢字<rt>ひらがな</rt></ruby>
- 片假名、平假名不需要標注
- 例如：「この<ruby>商品<rt>しょうひん</rt></ruby>は<ruby>人気<rt>にんき</rt></ruby>があります」
- ❌ 錯誤示範：「この商品は人気があります」（漢字沒有標注）
- ✅ 正確示範：「この<ruby>商品<rt>しょうひん</rt></ruby>は<ruby>人気<rt>にんき</rt></ruby>があります」`
        }
      ],
